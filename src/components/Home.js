...
class Home extends React.Component {
    ...
    componentDidMount() {
        ...
        Promise.all([
          fetch("https://high-bedrock-268705.appspot.com/nytimesHomeTab").then(valueNY => valueNY.json()),
          fetch("https://high-bedrock-268705.appspot.com/guardianHomeTab").then(valueG => valueG.json())
          ])
          .then(([valueNY, valueG]) => {
